<?php
/**
 * SeanyB functions and definitions
 *
...
if ( ! function_exists( 'seanyb_setup' ) ) :
	/**
	 ...
	 */
	function seanyb_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on SeanyB, use a find and replace
		 * to change 'seanyb' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'seanyb', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'seanyb' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'seanyb_custom_background_args', array(
...
add_action( 'after_setup_theme', 'seanyb_setup' );
 ...
 */
function seanyb_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'seanyb_content_width', 640 );
}
add_action( 'after_setup_theme', 'seanyb_content_width', 0 );
 ...
 */
function seanyb_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'seanyb' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'seanyb' ),
...
add_action( 'widgets_init', 'seanyb_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function seanyb_scripts() {
// 	wp_enqueue_style( 'seanyb-style', get_stylesheet_uri() );
  
  wp_enqueue_style( 'style.min', get_template_directory_uri() . '/css/style.min.css' );
  
  wp_enqueue_style( 'magnific-popup-css', get_template_directory_uri() . '/magnificpopup/magnific-popup.css');
  ...
  wp_enqueue_script( 'magnific-popup-js', get_template_directory_uri() . '/magnificpopup/jquery.magnific-popup.js', array('jQuery'), '20190906', true );
  
  wp_enqueue_script( 'magnific-popup', get_template_directory_uri() . '/js/magnific-popup.js', array('jQuery'), '20190906', true );
...
add_action( 'wp_enqueue_scripts', 'seanyb_scripts' );
